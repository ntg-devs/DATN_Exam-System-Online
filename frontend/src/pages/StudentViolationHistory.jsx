...
//       return { color: "bg-orange-100 text-orange-600", icon: <FaExclamationTriangle className="inline mr-1" /> };
//     } else {
//       return { color: "bg-gray-100 text-gray-600", icon: <FaExclamationTriangle className="inline mr-1" /> };
//     }
//   };
...
//                               {icon} Hành vi: {v.behavior} | Điểm: {v.score.toFixed(2)}
//                             </p>
//                           )}

//                           {v.reason && (
//                             <div className={`font-medium text-sm ${color} px-2 py-1 rounded-lg flex flex-col gap-1`}>
//                               {icon} Lý do: {v.reason}
//                               {v.faces?.map((f, i) => (
//                                 <div key={i} className="text-xs text-gray-700 flex justify-between">
//                                   <span>Label: {f.label}</span>
//                                   <span>Độ tương đồng: {f.similarity.toFixed(2)}</span>
//                                 </div>
//                               ))}
//                             </div>
//                           )}
